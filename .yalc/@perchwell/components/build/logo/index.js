...
function Logo(_ref) {
  var src = _ref.src,
      alt = _ref.alt,
      boxProps = _objectWithoutProperties(_ref, ["src", "alt"]);
  ...
  return /*#__PURE__*/_react["default"].createElement(_core.Box, _extends({
    ref: ref
  }, boxProps), src && inView ? /*#__PURE__*/_react["default"].createElement(Image, {
    src: src,
    alt: alt
  }) : null);
}
...
var Memo = /*#__PURE__*/_react["default"].memo(Logo);
